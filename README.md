...
3. Rachel up GitHub repository and raw image file structure for each group member
...
3. R Baker added images
    1. 3 subjects: Alexandra Daddario, Bilie Eilish, Chadwick Boseman
...
Processed images are stored in `processed data/Facial_recognition_[Test Train Val]` 
